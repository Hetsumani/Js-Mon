...
const CombatComponent = ({ onExitCombat }) => {
  ...
  const handleAttack = () => {
    ...
    const recoilDamage = 5;
    setPlayerHealth((prevHealth) => prevHealth - recoilDamage);

    setEnemyHealth(newEnemyHealth);
    setCombatMessage(`¡Atacaste e hiciste ${damage} de daño! Recibes ${recoilDamage} de daño de retroceso.`);
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ flex: 2, padding: "10px", borderRight: "4px solid black" }}
        >
          {combatMessage}
        </div>
        <div
        ...
        >
          <button onClick={handleAttack} disabled={enemyHealth <= 0}>
            Luchar
          </button>
